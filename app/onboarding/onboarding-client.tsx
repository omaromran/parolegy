...
export function OnboardingClient() {
  ...
  return (
    <main className="flex-1 container py-16 max-w-2xl mx-auto space-y-8">
      <div>
        <h1 className="font-serif text-3xl font-bold tracking-tight">Welcome to Parolegy</h1>
        ...
        <CardContent>
          {calendlyUrl ? (
            ...
            <p className="text-sm text-muted-foreground">
              Consultation scheduling will appear here when configured. You can continue to payment anytime.
            </p>
          )}
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            One plan — secure checkout with Stripe. After payment you will have full dashboard access.
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <p className="text-sm text-green-700 dark:text-green-400">Your email is verified.</p>
          ) : user ? (
            <p className="text-sm text-muted-foreground">
