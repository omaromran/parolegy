      ...
      <main className="flex-1 container flex items-center justify-center py-16">
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>
              If an account exists with that email, we&apos;ve sent a password reset link. It expires in 1
              hour.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {devResetUrl && (
              <div className="rounded-md bg-muted p-3 text-sm">
                ...
                <Link href={devResetUrl} className="text-primary break-all hover:underline">
                  {devResetUrl}
                </Link>
              </div>
            )}
